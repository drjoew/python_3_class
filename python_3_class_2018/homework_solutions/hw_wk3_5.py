...
new_file = open('revised_stock_data.csv', 'w')
stock_data=[]
comma_add=","
i=0
for line in f:
...
# Now lets delete lines 3, 5 and 11 and write the output to a new file
# revised_stock_data.csv

for i in range(0,3):
    new_file.write(stock_data[i])
for i in range(4,5):
    new_file.write(stock_data[i])
for i in range(6,11):
    new_file.write(stock_data[i])
